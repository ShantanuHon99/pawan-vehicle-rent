        ...
        <div class="col-md-12">
            <div class="card" style="border-radius: 10px; border: none; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1);">
                ...
                <div class="card-header"
                    style="background-color: #4b0082; color: white; border-top-left-radius: 10px; border-top-right-radius: 10px; text-align: center; padding: 20px;">
                ...
                <div class="card-body" style="background-color: white; padding: 30px; border-radius: 10px;">
                    ...
                    <h4 class="text-center"
                        style="color: #4b0082; margin-bottom: 20px; font-size: 2rem; font-weight: bold;">Register</h4>
                    ...
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label for="name" class="col-form-label"
                                style="font-weight: bold; color: #333; font-size: 1.2rem;">Name</label>
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label for="email" class="col-form-label"
                                style="font-weight: bold; color: #333; font-size: 1.2rem;">Email</label>
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label for="password" class="col-form-label"
                                style="font-weight: bold; color: #333; font-size: 1.2rem;">Password</label>
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label for="password_confirmation" class="col-form-label"
                                style="font-weight: bold; color: #333; font-size: 1.2rem;">Confirm Password</label>
    ...
    @enderror
                        ...
                        <div class="form-group mb-0" style="text-align: center;">
                            <button type="submit" class="btn"
                                style="background-color: #4b0082; color: white; border-color: #4b0082; padding: 14px 30px; border-radius: 5px; width: 100%; font-size: 1.2rem;">
                                Register
                            </button>
                        </div>
                        <div class="text-center" style="margin-top: 10px;">
                            <p style="font-size: 1rem; color: #555;">
                                ...
                                <a href="{{ route('admin.login') }}"
                                    style="color: #4b0082; font-weight: bold; text-decoration: none;">Login</a>
                            </p>
                        </div>
                    </form>
                </div>
